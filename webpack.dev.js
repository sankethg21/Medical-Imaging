...
module.exports = merge(common, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './tests/index1.html',
      filename: 'tests/index1.html',
    }),
    new HtmlWebpackPlugin({
      template: './tests/index2.html',
      filename: 'tests/index2.html',
    }),
    new HtmlWebpackPlugin({
      template: './tests/team.html',
      filename: 'tests/team.html',
    }),
    new HtmlWebpackPlugin({
      template: './tests/sample.html',
      filename: 'tests/sample.html',
    }),
    new HtmlWebpackPlugin({
      template: './tests/contact.html',
      filename: 'tests/contact.html',
    }),
  ],
  module: {
    rules: [
